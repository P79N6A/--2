...
public struct Waifu2x {
    ...
    static public func run(_ image: UIImage!, model: Model!, _ callback: @escaping (String) -> Void = { _ in }) -> UIImage? {
        ...
        debugPrint("hasalpha Time elapsed: \(timeInterval)")
        ...
        debugPrint("getCropRects Time elapsed: \(timeInterval)")
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("BackgroundTask Time elapsed: \(timeInterval)")
        // Output
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("out_pipeline Time elapsed: \(timeInterval)")
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("model_pipeline Time elapsed: \(timeInterval)")
        // Start running model
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("expand Time elapsed: \(timeInterval)")
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("generate_output Time elapsed: \(timeInterval)")
        ...
        nanotime = end.uptimeNanoseconds - start.uptimeNanoseconds
        timeInterval = Double(nanotime) / 1_000_000_000
        debugPrint("finished Time elapsed: \(timeInterval)")
        return outImage
    }
